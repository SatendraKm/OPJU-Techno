  ...
  return (
    <div className="relative space-y-10 px-4 py-8">
      ...
      <EventIntro
        ...
        pricepool={10000}
        description="Step into a high-energy clash of rhythm, creativity, and raw talent at our Dance Battle Event—where the floor becomes the battlefield and movement is the weapon. Dancers from diverse styles face off in head-to-head rounds, trading explosive footwork, sharp musicality, and fearless improvisation. The crowd fuels the momentum, judges watch for originality and control, and every beat drop is a chance to make a statement."
      />
