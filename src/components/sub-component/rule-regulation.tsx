...
const RulesAndRegulation: React.FC<RulesAndRegulationProps> = ({ rules, textClassName }) => {
  return (
    <div className="text-white my-20 sm:my-40 px-4">
      ...
      <div className="bg-[#33010140] p-4 sm:p-6 rounded-lg shadow-lg max-w-5xl mx-auto tracking-[6.72px] sm:tracking-[3.75px]">
        <ul className={`list-decimal pl-5 text-lg sm:text-2xl space-y-4 font-['Inter'] md:leading-10 tracking-[3.75px] ${textClassName}`}>
